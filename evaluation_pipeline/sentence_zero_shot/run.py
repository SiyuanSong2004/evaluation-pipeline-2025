...
def _parse_arguments():
    ...
    parser.add_argument("--task", required=True, type=str, help="The task that is being evaluated.", choices=["blimp", "ewok", "entity_tracking", "wug_adj", "wug_past", "comps", "vqa", "winoground", "zhoblimp"])
